...
from rail_utils.rail_utils import get_screenshot, count_down, any_image_on_screen
...
class MainTest(unittest.TestCase):
    def test(self):
        self.assertTrue(try_get_image_folder(ASSOCIATION_BID_DISABLED_FILES, gray_scale=False))
